package id.smartech.moviedatabase.activity.home.trending.byday
...
import id.smartech.moviedatabase.databinding.FragmentTrendingDayBinding
import id.smartech.moviedatabase.model.TvMovieModel

class TrendingDayFragment : BaseFragment<FragmentTrendingDayBinding>() {
    private lateinit var viewModel: TrendingDayViewModel
    private lateinit var adapter: TvMovieAdapter
    private lateinit var layoutManager: LinearLayoutManager
    private var listTrending = ArrayList<TvMovieModel>()

    override fun onCreate(savedInstanceState: Bundle?) {
        setLayout = R.layout.fragment_trending_day
    ...
    private fun setViewModel() {
        viewModel = ViewModelProvider(this).get(TrendingDayViewModel::class.java)
        viewModel.setService(createApi(activity))
        viewModel.getAllTrendingByDay()
    }
